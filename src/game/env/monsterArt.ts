...
export const MONSTER_ART = {
  [MobTexture.Toad]: {
    key: MobTexture.Toad,
    url: gameAssetUrl('assets/monsters/toad.png'),
    width: 50,
    height: 45,
    fallback: '#4a7a3c',
  },
  [MobTexture.Crab]: {
    key: MobTexture.Crab,
    url: gameAssetUrl('assets/monsters/crab.png'),
    width: 50,
    height: 44,
    fallback: '#3c6a8a',
  },
  [MobTexture.Serpent]: {
    ...
    url: gameAssetUrl('assets/monsters/serpent.png'),
    width: 60,
    height: 61,
    fallback: '#5a6a34',
  },
  [MobTexture.Drake]: {
    ...
    url: gameAssetUrl('assets/monsters/drake.png'),
    width: 71,
    height: 62,
    fallback: '#6a7a30',
  },
  [MobTexture.Golem]: {
    ...
    url: gameAssetUrl('assets/monsters/golem.png'),
    width: 64,
    height: 70,
    fallback: '#6a5238',
  },
  [MobTexture.Troll]: {
    ...
    url: gameAssetUrl('assets/monsters/troll.png'),
    width: 78,
    height: 74,
    fallback: '#8a7040',
  },
  [MobTexture.BloodSerpent]: {
    ...
    url: gameAssetUrl('assets/monsters/blood-serpent.png'),
    width: 71,
    height: 67,
    fallback: '#a04028',
  },
  [MobTexture.EmberGolem]: {
    ...
    url: gameAssetUrl('assets/monsters/ember-golem.png'),
    width: 64,
    height: 71,
    fallback: '#4a4048',
  },
  [MobTexture.FireDrake]: {
    ...
    url: gameAssetUrl('assets/monsters/fire-drake.png'),
    width: 71,
    height: 62,
    fallback: '#a05430',
  },
